...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const [script, servidor] = interaction.options.getString('script').split('|');

        const modal = new ModalBuilder()
            .setCustomId(`modal_remove_license_${userId}_${encodeURIComponent(script)}_${encodeURIComponent(servidor)}`)
