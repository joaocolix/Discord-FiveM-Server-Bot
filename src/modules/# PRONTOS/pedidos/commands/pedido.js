    ...
    run: async (client, interaction) => {
        if (!interaction.member.permissions.has(Discord.PermissionFlagsBits.Administrator)) {
            return interaction.reply(
                res.warning(`Você não tem permissão para isso.`, {
                    ephemeral: true
                })
            );
        }
        ...
        if (acao === 'configurar') {
            ...
            return await interaction.reply(
                res.info(`Escolha uma configuração abaixo:`, {
                    components: [row],
                    ephemeral: true
                })
            );
        ...
        if (acao === 'gerar') {
            ...
            if (!desc || !valor || !pagador) {
                return interaction.reply(
                    res.info(`Para gerar um pedido, você deve fornecer descrição, valor e pagador.`, {
                        ephemeral: true
                    })
                );
            }
            ...
            return interaction.reply(
                res.success(`Pedido gerado com sucesso!`, {
                    ephemeral: true
                })
            );
        }
