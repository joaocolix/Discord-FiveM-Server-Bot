...
const res = require('../../../utils/resTypes'); // ADICIONADO
...
client.on("interactionCreate", async (interaction) => {
    ...
    if (index > -1) {
        ...
        await interaction.update(
            res.success(`O cargo <@&${selectedRole}> foi removido da lista de permissões.`, {
                components: [],
                content: ``,
                ephemeral: true
            })
        ...
        await interaction.update(
            res.warning(`O cargo <@&${selectedRole}> não está na lista.`, {
                components: [],
                content: ``,
                ephemeral: true
            })
